...
namespace Contacts
{
    ...
    public partial class frmContacts : Form
    {
        ...
        private void BtnAjouter_Click(object sender, EventArgs e)
        {
            if (rbtnPro.Checked)
            {
                if (!txtNom.Text.Equals("") && !txtTel.Text.Equals(""))
                {
                    ...
                    Contact nouveauContact = new Professionnel(txtNom.Text, txtTel.Text, imgPhoto.Image);
            ...
            else
            {
                ...
                {
                    // créer le contact et l'ajouter dans la collection
                    Contact nouveauContact = new Particulier(txtNom.Text, txtPrenom.Text, txtTel.Text, imgPhoto.Image);
                    lesContacts.Add(nouveauContact);
                    // mettre à jour de la ListBox
                    MajListBox(nouveauContact.ToString());
                    // gérer la fin de l'ajout au niveau des objets graphiques
        ...
        private void rbtnPro_CheckedChanged(object sender, EventArgs e)
        {
